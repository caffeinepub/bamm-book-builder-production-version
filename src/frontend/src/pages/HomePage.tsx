...
import { BookOpen, Calendar, Edit, Loader2, LogIn, Trash2 } from "lucide-react";
...
export default function HomePage() {
  ...
  const handleCreateProject = (storyTitle: string, authorName: string) => {
    ...
    console.log(
      "[HomePage] Creating project with title:",
      storyTitle,
      "by author:",
      authorName,
    );
    ...
    createProject(storyTitle, {
      ...
      onError: (error: any) => {
        ...
        if (
          ...
          toast.error(
            "Please log in with Internet Identity to create projects",
          );
        } else {
          ...
          <div className="flex flex-col items-center gap-6 text-center">
            <div className="flex-1">
              ...
              <p className="mb-6 text-lg leading-relaxed text-muted-foreground">
                Craft timeless children's tales in the universal 8.5×8.5"
                format. Optimized for Amazon KDP with elegant print compliance,
        ...
        {isInitializing ? (
          ...
          <Card className="border-2 border-dashed">
            <CardContent className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mb-4 text-muted-foreground">
                Log in with Internet Identity to view and create your book
                projects.
              </p>
          ...
          <Card className="border-2 border-dashed">
            <CardContent className="empty-state flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mb-4 text-muted-foreground">
                Begin your first Amazon KDP children's book project to embark on
                this journey.
              </p>
              <NewProjectDialog
                onCreateProject={handleCreateProject}
        ...
        <AlertDialogContent className="dialog-box border-2 border-border z-modal">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-base">
              This action cannot be undone. This will permanently erase your
              book project and all associated content from the archives.
            </AlertDialogDescription>
          </AlertDialogHeader>
...
function ProjectCard({
  ...
  const { data: validation, isLoading: isLoadingValidation } = useKDPValidation(
    project.id,
  );
