...
actor {
  ...
  var images = Map.empty<Text, Image>();
  var userProfiles = Map.empty<Principal, UserProfile>();
  var fileOwnership = Map.empty<Text, Principal>();
  var projectOwners = Map.empty<Text, Principal>();
  var nextProjectId = 0;
  ...
  var subscriptions = Map.empty<Principal, SubscriptionRecord>();
